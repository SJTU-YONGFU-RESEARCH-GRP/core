...
| `fifos/circular_buffer_fifo.v` | SystemVerilog-2005, Verilog-1995 | module, multi-dimensional array, parameter | 0.000s | ✅ OK |
| `fifos/sync_fifo.v` | SystemVerilog-2005, Verilog-1995 | module, multi-dimensional array, parameter | 0.000s | ✅ OK |
...
| `fifos/fifo.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
| `fifos/fwft_fifo.v` | SystemVerilog-2005, Verilog-1995 | module, multi-dimensional array, parameter | 0.000s | ✅ OK |
| `fifos/bidirectional_fifo.v` | SystemVerilog-2005, Verilog-1995 | module, multi-dimensional array, parameter | 0.000s | ✅ OK |
| `fifos/cache_fifo.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | function, function return value, integer, module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
| `fifos/credit_based_fifo.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
| `fifos/configurable_sync_fifo.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
| `fifos/barrel_shifter_fifo.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | integer, module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
| `fifos/parameterized_priority_queue.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | integer, module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
| `fifos/showahead_fifo.v` | SystemVerilog-2005, Verilog-1995 | module, multi-dimensional array, parameter | 0.000s | ✅ OK |
| `fifos/smart_fifo.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
| `fifos/memory_mapped_fifo.v` | SystemVerilog-2005, Verilog-1995 | module, multi-dimensional array, parameter | 0.000s | ✅ OK |
| `fifos/pipelined_fifo.v` | SystemVerilog-2005, Verilog-1995 | array, integer, module, multi-dimensional array, parameter | 0.000s | ✅ OK |
| `fifos/configurable_param_fifo.v` | SystemVerilog-2005, Verilog-1995, Verilog-2001 | generate, module, multi-dimensional array, parameter, parameter dependency | 0.000s | ✅ OK |
...
| `fifos/skid_buffer.v` | Verilog-1995 | function, function return value, module, parameter | 0.000s | ✅ OK |
