...
class alignas(VL_CACHE_LINE_BYTES) Vconfigurable_sync_fifo___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ configurable_sync_fifo__DOT__wr_allow;
    CData/*0:0*/ configurable_sync_fifo__DOT__rd_allow;
    CData/*3:0*/ __Vdly__configurable_sync_fifo__DOT__wr_ptr;
    ...
    VlUnpacked<CData/*7:0*/, 16> configurable_sync_fifo__DOT__mem;
