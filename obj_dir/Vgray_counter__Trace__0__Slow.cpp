...
VL_ATTR_COLD void Vgray_counter___024root__trace_init_sub__TOP__0(Vgray_counter___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,0,"gray_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+5,0,"binary_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    ...
    tracep->declBus(c+4,0,"gray_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+5,0,"binary_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+6,0,"binary_count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vgray_counter___024root__trace_full_0_sub_0(Vgray_counter___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+4,(vlSelf->gray_out),4);
    bufp->fullCData(oldp+5,(vlSelf->binary_out),4);
    bufp->fullCData(oldp+6,(vlSelf->gray_counter__DOT__binary_count),4);
}
