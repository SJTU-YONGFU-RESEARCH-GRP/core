...
VL_INLINE_OPT void Vbarrel_shifter___024root___ico_sequent__TOP__0(Vbarrel_shifter___024root* vlSelf) {
    ...
    // Body
    vlSelf->barrel_shifter__DOT__temp_data = vlSelf->data_in;
    vlSelf->data_out = ((IData)(vlSelf->shift_direction)
                         ? ((IData)(vlSelf->rotate)
                             ? ((vlSelf->barrel_shifter__DOT__temp_data 
                                 << (IData)(vlSelf->shift_amount)) 
                                | VL_SHIFTR_III(32,32,32, vlSelf->barrel_shifter__DOT__temp_data, 
                                                ((IData)(0x20U) 
                                                 - (IData)(vlSelf->shift_amount))))
                             : (vlSelf->barrel_shifter__DOT__temp_data 
                                << (IData)(vlSelf->shift_amount)))
                         : ((IData)(vlSelf->rotate)
                             ? ((vlSelf->barrel_shifter__DOT__temp_data 
                                 >> (IData)(vlSelf->shift_amount)) 
                                | VL_SHIFTL_III(32,32,32, vlSelf->barrel_shifter__DOT__temp_data, 
                                                ((IData)(0x20U) 
                                                 - (IData)(vlSelf->shift_amount))))
                             : (vlSelf->barrel_shifter__DOT__temp_data 
                                >> (IData)(vlSelf->shift_amount))));
...
#endif
            VL_FATAL_MT("barrel_shifter.v", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("barrel_shifter.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("barrel_shifter.v", 1, "", "Active region did not converge.");
            }
...
void Vbarrel_shifter___024root___eval_debug_assertions(Vbarrel_shifter___024root* vlSelf) {
    ...
    // Body
    if (VL_UNLIKELY((vlSelf->shift_amount & 0xe0U))) {
        Verilated::overWidthError("shift_amount");}
    if (VL_UNLIKELY((vlSelf->shift_direction & 0xfeU))) {
        Verilated::overWidthError("shift_direction");}
    if (VL_UNLIKELY((vlSelf->rotate & 0xfeU))) {
        Verilated::overWidthError("rotate");}
}
#endif  // VL_DEBUG
