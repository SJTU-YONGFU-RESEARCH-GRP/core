...
void Vsipo_register___024root__trace_chg_0_sub_0(Vsipo_register___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        bufp->chgCData(oldp+0,(vlSelfRef.sipo_register__DOT__shift_reg),8);
        bufp->chgBit(oldp+1,(vlSelfRef.sipo_register__DOT__parity_bit));
        bufp->chgCData(oldp+2,(vlSelfRef.sipo_register__DOT__next_shift_reg),8);
        bufp->chgIData(oldp+3,(vlSelfRef.sipo_register__DOT__count_ones__Vstatic__i),32);
        bufp->chgIData(oldp+4,(vlSelfRef.sipo_register__DOT__count_ones__Vstatic__count),32);
    }
    bufp->chgBit(oldp+5,(vlSelfRef.clk));
    bufp->chgBit(oldp+6,(vlSelfRef.rst_n));
    bufp->chgBit(oldp+7,(vlSelfRef.serial_in));
    bufp->chgBit(oldp+8,(vlSelfRef.enable));
    bufp->chgCData(oldp+9,(vlSelfRef.parallel_out),8);
    bufp->chgBit(oldp+10,(vlSelfRef.parity_out));
}
