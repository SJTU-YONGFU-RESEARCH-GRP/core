...
#ifndef VERILATED_VMESH_ROUTER_H_
#define VERILATED_VMESH_ROUTER_H_  // guard

#include "verilated.h"

class Vmesh_router__Syms;
class Vmesh_router___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vmesh_router VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vmesh_router___024root* const rootp;
    ...
    explicit Vmesh_router(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vmesh_router(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vmesh_router();
  private:
    VL_UNCOPYABLE(Vmesh_router);  ///< Copying not allowed
