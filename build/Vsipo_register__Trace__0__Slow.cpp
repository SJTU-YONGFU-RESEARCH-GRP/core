...
VL_ATTR_COLD void Vsipo_register___024root__trace_init_sub__TOP__0(Vsipo_register___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,0,"next_shift_reg",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+4,0,"count_ones__Vstatic__i",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    tracep->declBus(c+5,0,"count_ones__Vstatic__count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vsipo_register___024root__trace_full_0_sub_0(Vsipo_register___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelfRef.sipo_register__DOT__shift_reg),8);
    bufp->fullBit(oldp+2,(vlSelfRef.sipo_register__DOT__parity_bit));
    bufp->fullCData(oldp+3,(vlSelfRef.sipo_register__DOT__next_shift_reg),8);
    bufp->fullIData(oldp+4,(vlSelfRef.sipo_register__DOT__count_ones__Vstatic__i),32);
    bufp->fullIData(oldp+5,(vlSelfRef.sipo_register__DOT__count_ones__Vstatic__count),32);
    bufp->fullBit(oldp+6,(vlSelfRef.clk));
    bufp->fullBit(oldp+7,(vlSelfRef.rst_n));
    bufp->fullBit(oldp+8,(vlSelfRef.serial_in));
    bufp->fullBit(oldp+9,(vlSelfRef.enable));
    bufp->fullCData(oldp+10,(vlSelfRef.parallel_out),8);
    bufp->fullBit(oldp+11,(vlSelfRef.parity_out));
}
